...
def generate_launch_description():
    ...
    l_file_name = 'config/left_cam_info.yaml'
    package_share_directory = get_package_share_directory('arducam_ros2_cpp')
    ...
    r_file_name = 'config/right_cam_info.yaml'
